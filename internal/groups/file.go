	...
	register(func(r *cli.Registry) {
		...
		r.Add(
			...
			&cli.Command{
				...
				Args:     "<path> [text...]",
				Examples: []string{`agentic-os file append log.txt "done"`},
			...
			&cli.Command{
				...
				Args:     "<path> [--json]",
				Examples: []string{"agentic-os file stat go.mod --json"},
				Run:      runFileStat,
			},
			&cli.Command{
				...
				Args:     "<path>",
				Examples: []string{"agentic-os file mkdir ~/.config/agentic-os/layouts"},
				Run:      runFileMkdir,
			},
			&cli.Command{
				...
				Examples: []string{"agentic-os file copy a.txt b.txt"},
				Run:      runFileCopy,
			},
			&cli.Command{
				...
				Args:     "<source> <destination>",
				Examples: []string{"agentic-os file move old.txt new.txt"},
				Run:      runFileMove,
			},
			&cli.Command{
				...
				Args:     "<path> [--recursive]",
				Examples: []string{"agentic-os file delete /tmp/scratch --recursive"},
				Run:      runFileDelete,
			},
		)
	})
