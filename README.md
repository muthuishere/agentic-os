...
| **Agents** | `serve` — expose all of the above over MCP; `headless` — run the desktop commands with no screen; `service` — keep any of it running as a per-user OS service |
